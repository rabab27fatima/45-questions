...
let guest_List2 : string[] = ["Azra", "Farah", "Luqman"];
let canNotAttend1 : string = "Luqman";
// console.log(canNotAttend1 + ' ' + "can't make the dinner");
let newPerson1 : string = "Badar";
