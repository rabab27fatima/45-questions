...
// Exercise 15 copied.
let guest_List1 : string[] = ["Azra", "Farah", "Luqman"];
let canNotAttend : string = "Luqman";
// console.log(canNotAttend + ' ' + "can't make the dinner");
let newPerson : string = "Badar";
